...
public class Home extends Fragment {
    ...
    private void Initialization() {
        llNotFound = (LinearLayout) view.findViewById(R.id.llNotFound);
        llNoQuestionsFound = (LinearLayout) view.findViewById(R.id.ll_No_Questions);
        pbHome = (ProgressBar) view.findViewById(R.id.pbHome);
